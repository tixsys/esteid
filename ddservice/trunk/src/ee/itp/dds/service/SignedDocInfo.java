...
public class SignedDocInfo  implements java.io.Serializable {
  ...
  private SignatureInfo[] signatureInfo;
     ...
     * @param dataFileInfo
     */
    public void setDataFileInfo(ee.itp.dds.service.DataFileInfo[] dataFileInfo) {
        this.dataFileInfo = dataFileInfo;
    }

    public ee.itp.dds.service.DataFileInfo getDataFileInfo(int i) {
        return this.dataFileInfo[i];
    }

    public void setDataFileInfo(int i, ee.itp.dds.service.DataFileInfo _value) {
     ...
     */
    public ee.itp.dds.service.SignatureInfo[] getSignatureInfo() {
        return signatureInfo;
    }
     ...
     * @param signatureInfo
     */
    public void setSignatureInfo(ee.itp.dds.service.SignatureInfo[] signatureInfo) {
        this.signatureInfo = signatureInfo;
    }

    public ee.itp.dds.service.SignatureInfo getSignatureInfo(int i) {
        return this.signatureInfo[i];
    }

    public void setSignatureInfo(int i, ee.itp.dds.service.SignatureInfo _value) {
