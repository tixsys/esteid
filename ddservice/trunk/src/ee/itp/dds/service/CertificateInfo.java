...
public class CertificateInfo  implements java.io.Serializable {
    ...
    public CertificateInfo(
           ...
           ee.itp.dds.service.CertificatePolicy[] policies) {
           this.issuer = issuer;
     ...
     * @return policies
     */
    public ee.itp.dds.service.CertificatePolicy[] getPolicies() {
        return policies;
    }
     ...
     * @param policies
     */
    public void setPolicies(ee.itp.dds.service.CertificatePolicy[] policies) {
        this.policies = policies;
    }

    public ee.itp.dds.service.CertificatePolicy getPolicies(int i) {
        return this.policies[i];
    }

    public void setPolicies(int i, ee.itp.dds.service.CertificatePolicy _value) {
