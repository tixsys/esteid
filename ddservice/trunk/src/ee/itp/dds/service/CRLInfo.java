...
public class CRLInfo  implements java.io.Serializable {
    ...
    private ee.itp.dds.service.RevokedInfo[] revocations;
    ...
    public CRLInfo(
           ...
           ee.itp.dds.service.RevokedInfo[] revocations) {
           this.issuer = issuer;
     ...
     * @return revocations
     */
    public ee.itp.dds.service.RevokedInfo[] getRevocations() {
        return revocations;
    }
     ...
     * @param revocations
     */
    public void setRevocations(ee.itp.dds.service.RevokedInfo[] revocations) {
        this.revocations = revocations;
    }

    public ee.itp.dds.service.RevokedInfo getRevocations(int i) {
        return this.revocations[i];
    }

    public void setRevocations(int i, ee.itp.dds.service.RevokedInfo _value) {
