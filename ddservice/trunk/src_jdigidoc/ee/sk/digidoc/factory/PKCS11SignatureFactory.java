...
public class PKCS11SignatureFactory implements SignatureFactory 
{
        ...
        throws DigiDocException 
    {
        ...
        try {
            ...
            iaik.pkcs.pkcs11.objects.Object[] foundCerts = sess.findObjects(1); // find first
            //System.out.println("Certs: " + foundCerts.length);
            if (foundCerts.length > 0) {
                //System.out.println("Examining cert data");
                X509PublicKeyCertificate pkcert = (X509PublicKeyCertificate)foundCerts[0];
                //System.out.println("Cert0: " + pkcert);
                ...
                //System.out.println("Cert data: " + encCert.length + " bytes");
                ...
                //System.out.println("KeyUsages: " + ((keyUsages != null) ? keyUsages.length : 0));
                if(keyUsages != null && keyUsages.length > 2 && keyUsages[1] == true) {
                    //System.out.println("Signature cert!");
                    rc = true;
                } //else
