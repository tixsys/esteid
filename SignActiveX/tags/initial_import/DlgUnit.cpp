...
int DialogUnitSetTexts(char *psCaption, char *psHeader, char *psOkButton, char *psCancelButton)
{
if (psCaption != NULL)
...
int DialogUnitSetHeaders(char *psCol1, char *psCol2, char *psCol3, char *psCol4, char *psCol5)
{
if (psCol1 != NULL)
...
int DialogUnitSetToolTips(char *psCommon, char *psListView, char *psOkButton, char *psCancelButton)
{
if (psCommon != NULL)
...
if (iRes == dDLGERROR_OUT)
  ...
  if (dwRes != 0)
    ...
    sprintf(sTemp,"DigiDoc Dialog Error=%d",dwRes);
    //DispError(sTemp);
    }
  #ifdef WIN32_CSP
