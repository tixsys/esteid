...
namespace digidoc
{
    class Signature
    {
      ...
      protected:
          ...
          void addReference(const std::string& uri, int digestMethod, std::vector<unsigned char> digestValue,
          ...
          static std::vector<unsigned char> calcSHA1OnNode(xercesc::DOMNode* node);
