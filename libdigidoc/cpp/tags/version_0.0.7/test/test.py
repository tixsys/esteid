...
class BDocTestCase(unittest.TestCase):
    ...
    def validateSignature(self, bdocFile, validOutputMustContain, validateOnline=False):
        ...
        if (bdocFile[0] != '/'): #relative to test/data/bdoc/
    ...
    def testValidateTM(self):
        """validateOffline BDocTM_r423.bdoc"""
        bdocFile = 'BDocTM_r423.bdoc'
        self.validateOffline(bdocFile)
    
    def testValidateTM(self):
        """validateOffline BDocTM_RSASigner_r430.bdoc"""
        bdocFile = 'BDocTM_RSASigner_r430.bdoc'
        self.validateOffline(bdocFile) 
    ...
    def testValidateSHA256(self):
        """validateOffline SHA256  BDocTM_SHA256_r427.bdoc"""
        bdocFile = 'BDocTM_SHA256_r427.bdoc'
        self.validateOffline(bdocFile)
    ...
    def testValidateOnline(self):
        """validateOnline BDocTM_r423.bdoc"""
        bdocFile = 'BDocTM_r423.bdoc'
    ...
    def testUnknownCACertNotFoundBESFails(self):
        """Check that signature with unknown CA is invalid - BDocBES_r423.bdoc"""
        bdocFile = 'BDocBES_r423.bdoc'
        self.checkUnknownCACertNotFoundFails(bdocFile)
        
    def testUnknownCACertNotFoundTMFails(self):
        """Check that signature with unknown CA is invalid - BDocTM_r423.bdoc"""
        bdocFile = 'BDocTM_r423.bdoc'
        self.checkUnknownCACertNotFoundFails(bdocFile)
