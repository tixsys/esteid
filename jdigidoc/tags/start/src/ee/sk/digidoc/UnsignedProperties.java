...
public class UnsignedProperties implements Serializable
{
        ...
        throws DigiDocException
    {
        ...
        try {
        	...
        	}else if(m_signature.getSignedDoc().getFormat().equals(SignedDoc.FORMAT_BDOC)) {
        		//IS FIX xmlns
            ...
            //A Inga <2008 aprill> BDOCiga seotud muudatused xml-is 1
            if(m_signature.getTimestampInfo(TimestampInfo.TIMESTAMP_TYPE_SIGNATURE) != null){
            	bos.write(m_signature.getTimestampInfo(TimestampInfo.TIMESTAMP_TYPE_SIGNATURE).toXML());
            }
            //L Inga <2008 aprill> BDOCiga seotud muudatused xml-is 1
            if(m_certRefs != null)
