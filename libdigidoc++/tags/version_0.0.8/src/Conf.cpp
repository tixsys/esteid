...
std::string digidoc::Conf::getManifestXsdPath() const
{
    ...
    return "file:///C:/develop/Smartlink/etc/schema/OpenDocument_manifest.xsd";
...
std::string digidoc::Conf::getXadesXsdPath() const
{
    ...
    return "file:///C:/develop/Smartlink/etc/schema/XAdES.xsd";
...
std::string digidoc::Conf::getDsigXsdPath() const
{
    // TODO: implement
    // TODO:NOTE:CAREFUL!!! See getManifestXsdPath()
    return "file:///C:/develop/Smartlink/etc/schema/xmldsig-core-schema.xsd";
...
{
    return "C:/develop/Smartlink/etc/certs/sk-test-ocsp-responder-2005.pem";
...
{
    return "C:/develop/Smartlink/etc/certs";
