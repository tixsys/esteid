...
namespace digidoc
{
  namespace manifest
  {
              ...
              const ::xml_schema::Properties& p)
    {
      ...
      ::std::auto_ptr< ::digidoc::manifest::Manifest > r (
        ::digidoc::manifest::manifest (
              ...
              const ::xml_schema::Properties& p)
    {
      ...
      return ::digidoc::manifest::manifest (isrc, f, p);
    }
              ...
              const ::xml_schema::Properties& p)
    {
      ...
      ::xsd::cxx::xml::sax::std_input_source isrc (is);
      return ::digidoc::manifest::manifest (isrc, h, f, p);
    }
              ...
              const ::xml_schema::Properties& p)
    {
      ...
      {
        ::std::auto_ptr< ::digidoc::manifest::Manifest > r (
          ::xsd::cxx::tree::traits< ::digidoc::manifest::Manifest, char >::create (
            e, f, 0));
        return r;
      }
...
namespace digidoc
{
  namespace manifest
  {
    ...
    manifest (::std::ostream& o,
              const ::digidoc::manifest::Manifest& s,
              ...
              ::xml_schema::Flags f)
    {
      ...
      ::xml_schema::dom::auto_ptr< xercesc::DOMDocument > d (
        ::digidoc::manifest::manifest (s, m, f));
    ...
    manifest (const ::digidoc::manifest::Manifest& s,
              const ::xml_schema::NamespaceInfomap& m,
              ::xml_schema::Flags f)
    {
      ::xml_schema::dom::auto_ptr< xercesc::DOMDocument > d (
      ...
      ::digidoc::manifest::manifest (*d, s, f);
      return d;
    }
