 ...
 */
digidoc::BDocException::BDocException(const std::string& file, int line, const std::string& msg)
 ...
 */
digidoc::BDocException::BDocException(const std::string& file, int line, const std::string& msg, const Exception& cause)
