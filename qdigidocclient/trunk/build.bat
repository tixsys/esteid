...
set libdigidoc++_include=C:\src\libdigidoc++-svn\build\target\include
set libdigidoc++_library=C:\src\libdigidoc++-svn\build\target\lib
...
set include_path=%libdigidoc++_include%;%openssl_include%;%zlib_include%;%libp11_include%;%xercesc_include%;%xmlsecurityc_include%;%xsd_include%
set library_path=%libdigidoc++_library%;%openssl_library%;%zlib_library%;%libp11_library%;%xercesc_library%;%xmlsecurityc_library%;%xsd_library%
