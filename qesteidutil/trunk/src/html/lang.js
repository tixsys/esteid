...
var htmlStrings = {
	...
	"labelChangingPIN13": new tr( "Kui olete unustanud PIN1 koodi, kuid teate PUK koodi, siis siin saate määrata uue PIN1 koodi.", "If you have forgotten PIN1, but know PUK, then here you can enter new PIN1.", "Если забыли PIN1 код, но знаете PUK код, тогда можете создать новый PIN1 код." ),
	...
	"loadPic": new tr( "Laen pilti", "Loading picture", "Загружаю картинку" ),
