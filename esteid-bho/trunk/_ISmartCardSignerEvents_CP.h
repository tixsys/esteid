...
template<class T>
class CProxy_ISmartCardSignerEvents :
	public IConnectionPointImpl<T, &__uuidof(_ISmartCardSignerEvents)>
{
public:
	...
	HRESULT Fire_ReadersChanged( LONG readerCount)
	{
		HRESULT hr = S_OK;
		T * pThis = static_cast<T *>(this);
		int cConnections = m_vec.GetSize();
