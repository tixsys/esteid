...
public class DataFileData  implements Serializable {
    ...
    private DataFileAttribute[] attributes;

    private String dfData;
     ...
     * @return attributes
     */
    public ee.itp.dds.service.DataFileAttribute[] getAttributes() {
        return attributes;
    }
     ...
     * @param attributes
     */
    public void setAttributes(ee.itp.dds.service.DataFileAttribute[] attributes) {
        this.attributes = attributes;
    }

    public ee.itp.dds.service.DataFileAttribute getAttributes(int i) {
        return this.attributes[i];
    }

    public void setAttributes(int i, ee.itp.dds.service.DataFileAttribute _value) {
